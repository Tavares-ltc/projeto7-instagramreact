...
const postContent = [
    ...
    { imgUser: "img/barked.svg", videoPost:"video/video.mp4", img_whoLiked: "img/adorable_animals.svg", whoLiked: "adorable_animals", likes: "99.159" },
]
function Post(props) {
    ...
    if (props.videoPost !== undefined) {
        ...
        return (
            <div class="post">
                ...
                <div class="conteudo">
                    <div class="imgPost">
                        <video src={props.videoPost} autoPlay
                            muted loop></video>
                        <ion-icon class={heartAnimation} name="heart"></ion-icon>
                    </div>
                </div>
...
function Posts() {
    return (
        <div class="posts">
            {postContent.map(item => (<Post imgUser={item.imgUser} imgPost={item.imgPost} videoPost={item.videoPost} img_whoLiked={item.img_whoLiked} whoLiked={item.whoLiked} likes={item.likes} />))}
        </div>
    )
}
